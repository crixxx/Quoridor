...
public abstract class Mensaje {
    ...
    public static Mensaje ReadFrom(DataInputStream idata) {
    ...
    public static class ErrorMessage extends Mensaje {
    ...
    public static class OkMessage extends Mensaje {
    ...
    public static class OkLogin extends Mensaje{
    ...
    public static class Login extends Mensaje {
    ...
    public static class Play extends Mensaje{
